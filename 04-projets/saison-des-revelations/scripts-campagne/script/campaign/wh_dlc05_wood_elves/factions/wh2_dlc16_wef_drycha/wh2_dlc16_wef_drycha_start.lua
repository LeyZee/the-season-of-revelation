-----------------------------------------------------------------------------------
--	Drycha (wh2_dlc16_wef_drycha) : script de faction, chargé avant le premier tick par saison_start.lua.
--
...
if cm:is_new_game() and not saison_bloquee and not saison_en_essai_auto() then
	saison_sur(
		"intro de Drycha",
		function()
			faction_intro:perform_intro("wh_dlc05_wood_elves", "wh2_dlc16_wef_drycha");
		end
	);
end;
